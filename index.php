					...
					<ul class="slider">
						...
						<li>
							<a href="works/registerapp/" target="_blank" rel="noopener noreferrer">
								...
								<div class="works_description">
									<p>データ登録サイトデモ（データの入出力・メールアドレス検索・csvダウンロード）</p>
									<p>使用技術：HTML / CSS / PHP / MySQL</p>
						...
						<li>
							<a href="https://random-cat-nu.vercel.app/" target="_blank" rel="noopener noreferrer">
								<img src="img/random-cat.jpg" alt="猫のジェネレーター">
								<div class="works_description">
									<p>猫ジェネレーター</p>
									<p>使用技術：React / TypeScript / Next.js / The Cat API</p>
									<a class="source" href="https://github.com/okuda1506/random_cat_generator" target="_blank" rel="noopener noreferrer">
										<p>ソースコード <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg"></p>
									</a>
								</div>
							</a>
		...
		<section id="skills">
			<div class="container">
				...
				<div class="skill_type fade-in">
					...
					<p>Next.js：現在習得中。TypeScriptとReactを用いた猫ジェネレーターアプリを作成 </p>
				...
				<div class="skill_type fade-in">
					...
					<p>microCMS：自作ブログの記事やタグを管理するのに使用。PHPやJavaScriptでのAPIデータ取得が可能</p>
